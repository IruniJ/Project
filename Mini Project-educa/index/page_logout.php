	...
	<body>
		...
		<section class="header">
			...
			<nav>
				...
				<a href="index page.html"><img src="images/logo.png"></a>
				...
				<div class="nav-links">
					...
					<div class="form-page-btn">
						...
						<a class="form-btn" href="logout.php" class="btn">Logout</a>
					</div>
					<ul>
						...
						<li><a href="">TUTORIALS <i class="fa fa-sort-desc"></i></a>
								<div class="dropdown-menu">
									<ul>
										<li><a href=#>Grade 06<i class="fa fa-caret-right" ></i></a></li>
										<li><a href=#>Grade 07<i class="fa fa-caret-right" ></i></a></li>
										<li><a href=#>Grade 08<i class="fa fa-caret-right" ></i></a></li>
										<li><a href=#>Grade 09<i class="fa fa-caret-right" ></i></a></li>
									</ul>
								</div>
						</li>
